...
4. This Node daemon passively listens for the `pg_notify` event and instantly executes the native RedBlink `dune admin grant-item-id` CLI command to deliver the item to the player's inventory in real-time.
